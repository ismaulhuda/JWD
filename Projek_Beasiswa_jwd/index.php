            ...
            <div class="content">
                ...
                <div class="content-wrapper">
                    <div class="container">
                        ...
                        <div class="beasiswa">
                            <h3>Jenis Pilihan Beasiswa:</h3>
                            <button class="btn btn-primary" onclick="showBeasiswaInfo('akademik')">Beasiswa Akademik</button>
                            <button class="btn btn-primary" onclick="showBeasiswaInfo('non-akademik')">Beasiswa Non Akademik</button>
                        </div>
                        </div>
                    </div>
                </div>       
