...
<body>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="process/akademik_tambah_proses.php" method="POST">
                                <div class="card-body">
                                <div class="data">
                                    <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="ipk" value="3.1" readonly>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="beasiswa" class="col-sm-2 col-form-label">Beasiswa</label>
                                        <div class="col-sm-10">
                                            <select class="form-select" name="beasiswa" aria-label="Default select example">
    ...
    <script>
        ...
        const ipkValue = 3.1; // Ganti nilai ini dengan IPK yang diambil dari sistem
